...
function random_menu_page(){
    add_menu_page('Pizza', 'Pizza!', 'manage_options', 'pizza', 'page_render', 'dashicons-smiley');
}
...
function page_render(){
    ...
    <h2>Maar waarom Pizza?</h2>
    <p>Pizza (deeg in het engels) kan je natuurlijk kneden tot wat jij zelf wil maken. Pizza? Brood? Koekjes? Noem het maar op.<br>
